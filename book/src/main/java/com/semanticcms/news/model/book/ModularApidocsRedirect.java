...
package com.semanticcms.news.model.book;
...
@WebServlet("/news/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/news/model/apidocs/com.semanticcms.news.model/com" + Objects.toString(req.getPathInfo(), ""),
